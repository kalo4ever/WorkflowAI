...
class TestStoreTaskRun:
    ...
    @pytest.fixture()
    def legacy_task_run(self, non_legacy_task_run: SerializableTaskRun):
    ...
    async def test_store_task_run_with_files(
        ...
        non_legacy_task_run: SerializableTaskRun,
        ...
        assert isinstance(stored_task_run, SerializableTaskRun)
    ...
    async def test_store_task_run_with_legacy_task(
        ...
        legacy_task_run: SerializableTaskRun,
        runs_service: RunsService,
        mock_storage: Mock,
        mock_file_storage: Mock,
    ):
