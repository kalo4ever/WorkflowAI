...
class RunsService:
    ...
    def _sanitize_run(self, run: Run) -> Run:
    ...
    async def list_runs(self, task_uid: int, query: SerializableTaskRunQuery) -> Page[Run]:
    ...
    @classmethod
    def _provider_for_pricing_task_run(cls, task_run: Run, model: Model):
    ...
    @classmethod
    async def _compute_cost(cls, task_run: Run, provider_factory: AbstractProviderFactory):
    ...
    @classmethod
    def _strip_private_fields(cls, task_run: Run):
    ...
    @classmethod
    def _strip_llm_completions(cls, task_run: Run):
        if not task_run.llm_completions:
            return task_run
