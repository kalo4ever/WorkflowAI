...
@workflowai.agent(id="task-description-generation", model=Model.CLAUDE_3_7_SONNET_20250219)
async def run_task_description_generation(
    task_input: TaskDescriptionGenerationTaskInput,
) -> TaskDescriptionGenerationTaskOutput:
    """You are a task analysis assistant specializing in understanding and describing task specifications.
