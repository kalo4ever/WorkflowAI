...
from .company_domain_from_email_agent import ClassifyEmailDomainAgentOutput
from .extract_company_info_from_domain_task import (
...
class TestSafeExtractCompanyDomain:
    ...
    async def test_non_company_domain(self):
        with patch(
            "core.agents.extract_company_info_from_domain_task.run_classify_email_domain_agent",
...
class TestSafeGenerateCompanyDescription:
    ...
    async def test_extract_company_info_success(self):
        ...
        with (
            patch(
                "core.agents.extract_company_info_from_domain_task.safe_extract_company_domain",
                new_callable=AsyncMock,
