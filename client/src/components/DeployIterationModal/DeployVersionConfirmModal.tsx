...
export function DeployVersionConfirmModal(
  props: DeployVersionConfirmModalProps
) {
  ...
  return (
    <AlertDialog
      ...
      text={
        'Your environment will automatically begin using the updated AI agent version.'
      }
