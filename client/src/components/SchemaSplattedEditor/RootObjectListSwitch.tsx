...
export function RootObjectListSwitch(props: RootObjectListSwitchProps) {
  ...
  const enabledClassNames =
    'cursor-pointer hover:bg-gray-200 bg-transparent! text-gray-500';
  const disabledClassNames =
    'bg-white text-gray-800 border-gray-300 border shadow-sm';
    ...
    <div className='h-9 w-fit flex items-center bg-gray-100 rounded-[2px] border border-gray-300 p-1 gap-1 ml-2 font-lato'>
      <SimpleTooltip content='Pick one if you only want one item' align='start'>
        <div
          className={cx(
            commonClassNames,
            !isRootObject ? enabledClassNames : disabledClassNames
          )}
      ...
      <SimpleTooltip
        content='Pick if you want multiple instances of entries'
        align='start'
      >
        <div
          className={cx(
